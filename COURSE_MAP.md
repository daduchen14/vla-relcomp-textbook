...
| 29 | 完善搬运到参照区域探针 | 轨迹距离、趋势、错误参照物 | approach detector | 📘 [教材已编写](mainline/day29/README.md)；真实 MuJoCo trajectory 待执行 |
...
| 38 | 实现被选中的最小模块 | 模块边界、接口、回归测试 | 单一 repair module | 📘 [教材已编写](mainline/day38/README.md)；教学候选未获真实训练授权 |
...
| 52 | 干净重跑主基线 | clean-room、缓存污染 | final baseline data | 📘 [教材已编写](mainline/day52/README.md)；final baseline 为 NOT_RUN |
...
| 60 | 冻结结果与允许的论文主张 | claim-evidence、负结果 | results lock；Gate 7 | 📘 [教材与 Gate 7 rehearsal 已编写](mainline/day60/README.md)；正式证据缺失，Gate 未通过 |
...
| Day | 真实项目任务 | 即时补充知识 | 当天必须产物 | 状态 |
|---:|---|---|---|---|
| 61 | 清理数据、脚本和可追溯索引 | tidy data、原始数据不可覆盖 | release candidate data | 📘 [教材已编写](mainline/day61/README.md)；正式逐 episode 数据待执行 |
| 62 | 生成最终表格 | caption、计数、区间、加粗规则 | paper tables | 📘 [教材已编写](mainline/day62/README.md)；正式表格待真实 release 数据 |
...
| 70 | 不看答案复写核心模块并复现关键证据 | 迁移、代码所有权、最终自检 | final capstone；Gate 8 | 📘 [教材与 Gate 8 machine rehearsal 已编写](mainline/day70/README.md)；学习者 fresh-clone/live oral 未通过 |
