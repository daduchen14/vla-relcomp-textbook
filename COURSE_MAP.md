...
| 3 | ⬜ 未完成 | 函数、模块、路径与可测试的数据校验 | Day 2 字典/列表 | `episode_schema.py`、最小单元测试 |
| 4 | ⬜ 未完成 | Git 提交、分支、差异与可恢复实验 | Day 1 终端 | 练习仓库、提交清单与 diff 解读 |
| 5 | ⬜ 未完成 | Linux 文件、进程、环境变量与退出码 | Day 1–4 | `system_snapshot.py` 与进程练习 |
