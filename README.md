...
- 已建立：Day 0 诊断与跳过机制。
- 教材制作进度：[Day 1–70](COURSE_MAP.md) 已全部编写，其中 [Day 3](mainline/day03/README.md) 保留“代表性样章”标记；最终免费本地验收已通过（V2 结构、本地链接、Python 语法和 411 项测试）。
- Gate 1–8 均只有教材、静态契约或合成 fixture/rehearsal 验收，学习者尚未通过；真实 episode、模型 pilot、阈值视频抽查、oracle pilot、中断恢复与 Gate 8 live oral 均待学习者或合格 Linux/NVIDIA 环境执行。
