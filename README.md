...
- 已建立：Day 0 诊断与跳过机制。
- 教材制作进度：[Day 1–69](COURSE_MAP.md) 已编写，其中 [Day 3](mainline/day03/README.md) 保留“代表性样章”标记；下一编写入口是 Day 70。
- Gate 1–7 均只有教材、静态契约或合成 fixture/rehearsal 验收，学习者尚未通过；真实 episode、模型 pilot、阈值视频抽查、oracle pilot 与中断恢复均待合格 Linux/NVIDIA 环境执行。
