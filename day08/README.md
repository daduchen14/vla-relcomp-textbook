...
```text
day08/code/minimal_episode.py
day08/code/mini_evaluator.py
day08/tests/test_mini_evaluator.py
```

运行产物：

```text
learner_outputs/day08/fixture_steps.csv
learner_outputs/day08/fixture_episode_summary.json
```
...
```bash
sed -n '1,160p' day08/code/minimal_episode.py
python3 day08/code/minimal_episode.py
```
...
```bash
sed -n '1,140p' day08/code/mini_evaluator.py
sed -n '141,320p' day08/code/mini_evaluator.py
python3 day08/code/mini_evaluator.py --help
```

默认运行：

```bash
python3 day08/code/mini_evaluator.py
echo $?
sed -n '1,20p' learner_outputs/day08/fixture_steps.csv
sed -n '1,120p' learner_outputs/day08/fixture_episode_summary.json
```
...
```bash
python3 -m unittest -v day08.tests.test_mini_evaluator
