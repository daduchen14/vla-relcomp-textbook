...
V2 迁移和 Day 1–70 教材已经完成；下一入口是全仓免费验收与 Draft PR 审阅。学习者 Gate 1–8、模型 pilot、formal baseline 与真实运行/探针/干预尚无证据。必须继续保持“教材已编写 / 学习者已完成 / GPU 待验证”分离，不得由 Agent 代记 Gate 通过。
