...
.venv-day06/bin/python day13/code/minimal_optimizer.py
```
...
```bash
sed -n '1,180p' day14/code/minimal_dataset.py
.venv-day06/bin/python day14/code/minimal_dataset.py
```
...
```bash
sed -n '1,170p' day14/code/reproducible_loader.py
sed -n '171,340p' day14/code/reproducible_loader.py
.venv-day06/bin/python day14/code/reproducible_loader.py --help
.venv-day06/bin/python day14/code/reproducible_loader.py
echo $?
```
...
```bash
sed -n '1,260p' learner_outputs/day14/loader_manifest.json
```
...
```bash
.venv-day06/bin/python -m unittest -v day14.tests.test_reproducible_loader
.venv-day06/bin/python -m py_compile \
  day14/code/minimal_dataset.py \
  day14/code/reproducible_loader.py \
  day14/tests/test_reproducible_loader.py
```
...
.venv-day06/bin/python day14/code/reproducible_loader.py \
  --num-workers 2 \
  --output learner_outputs/day14/loader_workers2.json
```
