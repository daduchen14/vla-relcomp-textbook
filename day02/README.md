...
```bash
sed -n '1,360p' day02/code/episode_recorder.py
```
...
```bash
cd "$(git rev-parse --show-toplevel)"
sed -n '1,20p' day02/data/mini_episodes.csv
```
...
```bash
python3 day02/code/episode_recorder.py --help
```
...
L1: 1/2 = 50.0%
L2: 0/2 = 0.0%
Saved normalized CSV: .../learner_outputs/day02/normalized_episodes.csv
Saved summary JSON: .../learner_outputs/day02/summary.json
```
...
```bash
sed -n '1,20p' \
  learner_outputs/day02/normalized_episodes.csv
```
...
```bash
python3 -m json.tool \
  learner_outputs/day02/summary.json
```
...
```bash
mkdir -p learner_outputs/day02
cp day02/data/mini_episodes.csv \
  learner_outputs/day02/my_episodes.csv
```
...
```bash
python3 day02/code/episode_recorder.py \
  --input-csv learner_outputs/day02/my_episodes.csv \
  --output-dir learner_outputs/day02/experiment_a
```
...
```bash
python3 day02/code/episode_recorder.py \
  --input-csv learner_outputs/day02/bad_success.csv \
  --output-dir learner_outputs/day02/experiment_c
echo $?
```
