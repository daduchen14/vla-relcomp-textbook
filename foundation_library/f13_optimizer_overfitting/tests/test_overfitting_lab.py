...
from foundation_library.f13_optimizer_overfitting.code.overfitting_lab import (
    FixtureMLP,
    make_fixture_splits,
    make_loader,
    summarize,
...
class OverfittingLabTests(unittest.TestCase):
    ...
    def test_summary_uses_lowest_validation_epoch(self) -> None:
        from foundation_library.f13_optimizer_overfitting.code.overfitting_lab import EpochRecord
