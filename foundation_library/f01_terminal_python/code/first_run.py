...
def locate_paths() -> tuple[Path, Path]:
    ...
    # 源文件位于“教程/foundation_library/f01_terminal_python/code/”中，向上三级就是教程根目录。
    tutorial_root = script_path.parents[3]

    # / 运算符在 Path 中表示连接下一段路径，并不表示数学除法。
    output_dir = tutorial_root / "learner_outputs" / "foundation_library" / "f01_terminal_python"
