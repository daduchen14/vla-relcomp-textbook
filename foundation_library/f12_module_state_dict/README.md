...
```bash
sed -n '1,180p' foundation_library/f12_module_state_dict/code/minimal_module.py
.venv-foundation_library/f06_environments_dependencies/bin/python foundation_library/f12_module_state_dict/code/minimal_module.py
```
...
```bash
sed -n '1,160p' foundation_library/f12_module_state_dict/code/module_lab.py
sed -n '161,340p' foundation_library/f12_module_state_dict/code/module_lab.py
.venv-foundation_library/f06_environments_dependencies/bin/python foundation_library/f12_module_state_dict/code/module_lab.py --help
...
```bash
sed -n '1,220p' learner_outputs/foundation_library/f12_module_state_dict/fixture_module_report.json
sed -n '1,12p' learner_outputs/foundation_library/f12_module_state_dict/fixture_module_history.csv
ls -lh learner_outputs/foundation_library/f12_module_state_dict/fixture_regressor_state.pt
```
...
```bash
.venv-foundation_library/f06_environments_dependencies/bin/python -m unittest -v foundation_library.f12_module_state_dict.tests.test_module_lab
.venv-foundation_library/f06_environments_dependencies/bin/python -m py_compile \
  foundation_library/f12_module_state_dict/code/minimal_module.py \
  foundation_library/f12_module_state_dict/code/module_lab.py \
  foundation_library/f12_module_state_dict/tests/test_module_lab.py
```
