...
.venv-foundation_library/f06_environments_dependencies/bin/python foundation_library/f09_tensors/code/tensor_lab.py --device cpu
.venv-foundation_library/f06_environments_dependencies/bin/python -c 'import torch; print(torch.__version__)'
```

今天新增 `minimal_gradient.py`、完整 `autograd_lab.py` 和 4 项测试。个人输出位于 `learner_outputs/foundation_library/f10_autograd/gradient_report.json`。
...
```bash
sed -n '1,160p' foundation_library/f10_autograd/code/minimal_gradient.py
.venv-foundation_library/f06_environments_dependencies/bin/python foundation_library/f10_autograd/code/minimal_gradient.py
```
...
```bash
sed -n '1,140p' foundation_library/f10_autograd/code/autograd_lab.py
sed -n '141,300p' foundation_library/f10_autograd/code/autograd_lab.py
.venv-foundation_library/f06_environments_dependencies/bin/python foundation_library/f10_autograd/code/autograd_lab.py --help
...
```bash
sed -n '1,220p' learner_outputs/foundation_library/f10_autograd/gradient_report.json
```
...
```bash
.venv-foundation_library/f06_environments_dependencies/bin/python -m unittest -v foundation_library.f10_autograd.tests.test_autograd_lab
.venv-foundation_library/f06_environments_dependencies/bin/python -m py_compile \
  foundation_library/f10_autograd/code/minimal_gradient.py \
  foundation_library/f10_autograd/code/autograd_lab.py \
  foundation_library/f10_autograd/tests/test_autograd_lab.py
```
...
```bash
.venv-foundation_library/f06_environments_dependencies/bin/python foundation_library/f10_autograd/code/autograd_lab.py --epsilon 1e-2
.venv-foundation_library/f06_environments_dependencies/bin/python foundation_library/f10_autograd/code/autograd_lab.py --epsilon 1e-12
```
