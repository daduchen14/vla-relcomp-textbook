...
if __name__ == "__main__":
    # __file__ 指当前脚本；parents[3] 从 foundation_library/f03_modules_testing/code 回到仓库根目录。
    csv_path = Path(__file__).resolve().parents[3] / "foundation_library/f02_csv_json/data/mini_episodes.csv"
