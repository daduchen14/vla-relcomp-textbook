...
def default_paths() -> tuple[Path, Path]:
    ...
    manifest = root / "foundation_library/f06_environments_dependencies/config/fixture_requirements.json"
    output = root / "learner_outputs/foundation_library/f06_environments_dependencies/environment_report.json"
