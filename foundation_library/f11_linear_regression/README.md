...
.venv-foundation_library/f06_environments_dependencies/bin/python foundation_library/f10_autograd/code/autograd_lab.py
...
```bash
sed -n '1,180p' foundation_library/f11_linear_regression/code/minimal_linear_regression.py
.venv-foundation_library/f06_environments_dependencies/bin/python foundation_library/f11_linear_regression/code/minimal_linear_regression.py
```
...
```bash
sed -n '1,150p' foundation_library/f11_linear_regression/code/train_linear_regression.py
sed -n '151,330p' foundation_library/f11_linear_regression/code/train_linear_regression.py
.venv-foundation_library/f06_environments_dependencies/bin/python foundation_library/f11_linear_regression/code/train_linear_regression.py --help
.venv-foundation_library/f06_environments_dependencies/bin/python foundation_library/f11_linear_regression/code/train_linear_regression.py
echo $?
```
...
```bash
sed -n '1,15p' learner_outputs/foundation_library/f11_linear_regression/fixture_training_history.csv
sed -n '1,180p' learner_outputs/foundation_library/f11_linear_regression/fixture_training_report.json
```
...
```bash
.venv-foundation_library/f06_environments_dependencies/bin/python -m unittest -v foundation_library.f11_linear_regression.tests.test_train_linear_regression
.venv-foundation_library/f06_environments_dependencies/bin/python -m py_compile \
  foundation_library/f11_linear_regression/code/minimal_linear_regression.py \
  foundation_library/f11_linear_regression/code/train_linear_regression.py \
  foundation_library/f11_linear_regression/tests/test_train_linear_regression.py
```
...
```bash
.venv-foundation_library/f06_environments_dependencies/bin/python foundation_library/f11_linear_regression/code/train_linear_regression.py \
  --noise-scale 0 --output-dir learner_outputs/foundation_library/f11_linear_regression/no_noise
```
