...
```bash
sed -n '1,180p' day13/code/minimal_optimizer.py
...
```bash
sed -n '1,170p' day13/code/overfitting_lab.py
sed -n '171,340p' day13/code/overfitting_lab.py
.venv-day06/bin/python day13/code/overfitting_lab.py --help
.venv-day06/bin/python day13/code/overfitting_lab.py
echo $?
```
...
```bash
sed -n '1,15p' learner_outputs/day13/fixture_learning_curves.csv
sed -n '1,180p' learner_outputs/day13/fixture_overfitting_report.json
```

## 6. 自动化测试

```bash
.venv-day06/bin/python -m unittest -v day13.tests.test_overfitting_lab
.venv-day06/bin/python -m py_compile \
  day13/code/minimal_optimizer.py \
  day13/code/overfitting_lab.py \
  day13/tests/test_overfitting_lab.py
```
